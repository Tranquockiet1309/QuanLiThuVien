        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Img = table.Column<string>(type: "nvarchar(200)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileImg = table.Column<string>(type: "nvarchar(200)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PointsLedger", x => x.LedgerId);
                    table.ForeignKey(
                        name: "FK_PointsLedger_CheckIns_CheckInId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckIns_UserId_CheckInTime",
                table: "CheckIns",
                columns: new[] { "UserId", "CheckInTime" });

            migrationBuilder.CreateIndex(
                name: "IX_PointsLedger_CheckInId",
                table: "PointsLedger",
                column: "CheckInId");
